...
\begin{itemize}
\item implementację prostego, powtarzalnego potoku wykrywania włamań z wyjaśnieniami SHAP dla modeli Random Forest i XGBoost w trybie wieloklasowym;
